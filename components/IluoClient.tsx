...
import { Search, ChevronRight, BarChart3, Users } from "lucide-react";
...
interface IluoClientProps {
    initialEmployees: IluoEmployee[];
}

export default function IluoClient({ initialEmployees }: IluoClientProps) {
