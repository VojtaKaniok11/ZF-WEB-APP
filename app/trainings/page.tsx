...
import { getPersonalNumbersWithTrainings } from "@/lib/mock-trainings";
import PersonList from "@/components/PersonList";

export const metadata = { title: "Školení | ZF HR Portal" };

export default function TrainingsPage() {
    const relevantPNs = getPersonalNumbersWithTrainings();
